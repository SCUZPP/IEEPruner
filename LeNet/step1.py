...
class Individual():
    ...
    def evaluate(self, model, args, train_loader, test_loader, val_loader, original_filter):
        self.obj[0], self.obj[1] = evaIndividual(self.dec, model, args, train_loader, test_loader, val_loader, original_filter)
...
def get_population(model, args, train_loader, test_loader, val_loader):
    ...
    #以文件形式存储
    pickle.dump(population_init, open('population_dict/population_dict.pkl', 'wb'))
